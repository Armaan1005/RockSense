...
const RescueSidebar: React.FC<RescueSidebarProps> = ({
                ...
                <AccordionItem value={`item-${index}`} key={index}>
                  <AccordionTrigger>
                    <div className="flex items-center gap-2 w-full">
                        <span className="w-3 h-3 rounded-full mt-1 flex-shrink-0" style={{backgroundColor: RISK_COLORS[zone.riskLevel] || '#fff'}}></span>
                  ...
                  <AccordionContent className="space-y-3">
                    ...
                    <div className='flex flex-col gap-2 text-sm'>
                      ...
                      <span className='font-semibold text-foreground pl-6'>{zone.recommendation}</span>
                    </div>
                  </AccordionContent>
                </AccordionItem>
              ))}
  ...
  const reportsContent = (
    <div className="p-4 space-y-4">
        ...
        <Separator />
        <Button onClick={onExport} disabled={isExporting || !hasAnalysisData}>
